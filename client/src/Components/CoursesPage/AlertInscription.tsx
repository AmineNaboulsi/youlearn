            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                         <button
                                onClick={onValide}
                                type="button" className="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 sm:ml-3 sm:w-auto">{Logged ? 'Inscript': 'Sign in first '}</button>
                         <button
                                onClick={onCancel}
...
export default AlertInscription